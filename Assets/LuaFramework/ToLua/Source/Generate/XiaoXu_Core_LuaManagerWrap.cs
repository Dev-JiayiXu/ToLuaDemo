...
public class XiaoXu_Core_LuaManagerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(XiaoXu.Core.LuaManager), typeof(XiaoXu.Core.BaseManager));
	...
	static int OnInit(IntPtr L)
	{
		try
		{
			...
			XiaoXu.Core.LuaManager obj = (XiaoXu.Core.LuaManager)ToLua.CheckObject<XiaoXu.Core.LuaManager>(L, 1);
			obj.OnInit();
			return 0;
		}
		catch (Exception e)
